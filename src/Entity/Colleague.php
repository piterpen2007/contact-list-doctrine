...
final class Colleague extends Recipient
{
     ...
     */
    public function __construct(int $id_recipient, string $full_name, string $birthday, string $profession,string $department, string $position, string $roomNumber)
    {
    ...
    public static function createFromArray(array $data): Colleague
    {
        ...
        return new Colleague($data['id_recipient'],$data['full_name'],$data['birthday'],$data['profession'], $data['department'],$data['position'],$data['room_number']);
    }
